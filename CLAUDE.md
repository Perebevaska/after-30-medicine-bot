...
- **Статистика** (`menu:stats`): кнопки «📈 За 7 дней», «📊 Соблюдение за 30 дней» (adherence, `stats:adherence`) и «📆 План на 7 дней»; под отчётами история/план/соблюдение — кнопка «📄 Скачать PDF» (`export:week`/`export:plan`/`export:adherence`)
