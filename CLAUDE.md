...
| ~~29~~ | ~~`handlers/meds.py`~~ | ~~Нельзя отредактировать лекарство с разными дозировками~~ — ✅ исправлено: имя/дозировка А/способ приёма редактируются; расписание заблокировано с сообщением |
